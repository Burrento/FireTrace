            ...
            <form className="report-form" onSubmit={handleSubmit}>
                ...
                <section className="report-panel">
                    ...
                    <div className="report-field">
                        <label className="incident-text" htmlFor="incident-select">Incident type <span>Required</span></label>
                    <select
                        id="incident-select"
                        name="incident_type"
                    ...
                    <div className="report-field">
                    <label className="description-text" htmlFor="description">Description <span>Optional</span></label>
                    <textarea
                        id="description"
                        name="description"
                    ...
                    <div className="report-field">
                        ...
                        <div className="date-time-container">
                            <input type="text" id="date" value={date} readOnly aria-label="Date" />
                            <input type="text" id="time" value={time} readOnly aria-label="Time" />
                        </div>
                    </div>
                </section>
                ...
                <section className="report-panel">
                    <div className="report-panel-heading">
                        <h2>Fire location</h2>
                        <p>Place the pin as close as you can to the incident.</p>
                    </div>
                ...
                <div className="report-field">
                <label className="address-text" htmlFor="address">Address / landmark <span>Optional</span></label>
                    <textarea
                ...
                <section className="report-panel">
                <div className="report-panel-heading">
                    <h2>Supporting photo <span>Optional</span></h2>
                    <p>Add a photo to give BFP more context about the incident.</p>
                </div>
                ...
                <div className="report-submit-area">
                    <p>Reports are sent to BFP for review.</p>
